          ...
          <div className="flex gap-6 sm:gap-8 py-16 sm:py-20 lg:py-32 items-center justify-center flex-col">
            <div className="relative z-20">
              <Button 
                ...
                type="button"
              >
                Découvrir notre approche <MoveRight className="w-3 h-3 sm:w-4 sm:h-4" />
              </Button>
            </div>
            <div className="flex gap-4 sm:gap-6 flex-col">
              <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl max-w-5xl tracking-tighter text-center font-regular leading-tight">
                <span className="text-foreground block mb-2 sm:mb-4">Des solutions</span>
              ...
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed tracking-tight text-muted-foreground max-w-3xl text-center px-4">
                De la création de sites web professionnels aux applications sur mesure, 
                nous développons des solutions digitales qui font la différence. 
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 w-full sm:w-auto px-4 sm:px-0 relative z-20">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 sm:gap-4 w-full sm:w-auto px-6 py-3 text-sm sm:text-base font-medium border-2 border-gray-300 bg-white hover:bg-gray-50 rounded-lg transition-all duration-200 cursor-pointer relative z-20"
                type="button"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 sm:gap-4 w-full sm:w-auto px-6 py-3 text-sm sm:text-base font-medium bg-black text-white hover:bg-gray-800 rounded-lg transition-all duration-200 cursor-pointer relative z-20"
                type="button"
              >
